    ...
    return (
        <div className="min-h-screen bg-[#faf9f7] text-[#0a0a0a] font-sans selection:bg-[#0a0a0a] selection:text-white">
            ...
            <nav className="flex justify-between items-center px-6 md:px-12 py-8 bg-[#faf9f7]/80 backdrop-blur-md sticky top-0 z-50 border-b border-[#ede9e3]">
                ...
                <div className="flex gap-8 items-center">
                    <div className="relative">
                        ...
                        {showUserMenu && (
                            <div className="absolute right-0 mt-4 w-48 bg-white border border-[#ede9e3] shadow-2xl py-2 z-[60]">
                                <button
                                    onClick={() => { handleLogout(); setShowUserMenu(false); }}
                                    className="w-full flex items-center gap-3 px-4 py-3 text-[10px] tracking-[0.2em] font-bold hover:bg-[#faf9f7]"
                                >
            ...
            <main className="max-w-[1000px] mx-auto px-6 py-16">
                ...
                {orders.length === 0 ? (
                    <div className="text-center py-24 bg-white border border-[#ede9e3] rounded-sm">
                    ...
                    <div className="space-y-12">
                        {orders.map((order) => (
                            <div key={order._id} className="bg-white border border-[#ede9e3] rounded-sm overflow-hidden shadow-sm hover:shadow-md transition-shadow">
                                {/* Order Header */}
                                <div className="bg-[#faf9f7] px-6 py-4 border-b border-[#ede9e3] flex flex-wrap justify-between items-center gap-4">
                                    ...
                                    <div className="flex items-center gap-2 px-3 py-1 bg-white border border-[#ede9e3] rounded-full">
                                ...
                                <div className="p-6 divide-y divide-[#f2f1ef]">
                                    {order.orderItems.map((item, idx) => (
                                        <div key={idx} className="py-6 first:pt-0 last:pb-0 flex gap-6">
                                            <div className="w-24 h-32 bg-[#f2f1ef] rounded-sm overflow-hidden shrink-0">
                                ...
                                {/* Footer Info */}
                                <div className="px-6 py-4 bg-[#faf9f7]/50 border-t border-[#ede9e3] flex justify-between items-center text-[9px] tracking-widest text-[#999] font-bold uppercase">
            ...
            <footer className="border-t border-[#ede9e3] py-20 px-6 text-center bg-white mt-24">
